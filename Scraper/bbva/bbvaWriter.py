...
def Writer(lista):
    ...
    usdc, usdv, eurc, eurv, uruc, uruv, reac, reav = lista[0], lista[1], lista[2], lista[3], lista[4], lista[5], lista[6], lista[7]
    ...
    datos = (usdc, usdv, eurc, eurv, reac, reav, uruc, uruv)
...
# # DB Schema:
#
# MariaDB [cotizame]> describe bbva;
# +---------+--------------+------+-----+---------+-------+
...
# | eur_com | decimal(4,2) | YES  |     | NULL    |       |
# | eur_ven | decimal(4,2) | YES  |     | NULL    |       |
# | rea_com | decimal(4,2) | YES  |     | NULL    |       |
# | rea_ven | decimal(4,2) | YES  |     | NULL    |       |
# | uru_com | decimal(4,2) | YES  |     | NULL    |       |
# | uru_ven | decimal(4,2) | YES  |     | NULL    |       |
# +---------+--------------+------+-----+---------+-------+
