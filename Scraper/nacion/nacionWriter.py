...
def Writer(lista):
    ...
    usdc, usdv, eurc, eurv, reac, reav = lista[0], lista[1], lista[2], lista[3], lista[4], lista[5]
    ...
    datos = (usdc, usdv, eurc, eurv, reac, reav)

    # Inserta en la databases
    mycursor.execute(sqlFormula, datos) # SIEMPRE separar por ',', nunca con '%'
    mydb.commit()
    print('Proceso finalizado')

# # DB Schema:
#
# MariaDB [cotizame]> describe nacion;
#     -> ;
# +---------+--------------+------+-----+---------+-------+
